                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <div class="single-input email">
                            <input type="email" placeholder="이메일" value ="Email [ ]" readonly />
                          </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="single-input">
                              <input type="text" placeholder="# 해시태그" />  <!-- input 넓이 정리  -->
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="single-input email">
                              <input type="text" placeholder="이미지" value ="[이미지파일]" readonly />
                            </div>
                          </div>
                        <!-- hidden 값 -->
                        <input type="hidden" placeholder="작성자id"  value ="작성자id가져오기" />
                        <input type="hidden" placeholder="작성자이름"  value ="작성자이름가져오기" />
